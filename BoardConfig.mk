...
TARGET_BOOTLOADER_BOARD_NAME := Bravis_Alpha
...
# Kernel
TARGET_PREBUILT_KERNEL := device/Bravis/Alpha/kernel
BOARD_KERNEL_CMDLINE :=
BOARD_CUSTOM_BOOTIMG_MK := device/Bravis/Alpha/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/Bravis/Alpha/recovery/root/etc/twrp.fstab
